...
{
    public partial class Project02Context : DbContext
    {
        public Project02Context()
        {
        }

        public Project02Context(DbContextOptions<Project02Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Initial Catalog=Project02;Data Source=WALVIS-PC\\MSSQLSERVER2019;Trusted_Connection=true");
            }
